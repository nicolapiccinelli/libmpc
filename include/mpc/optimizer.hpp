...
namespace mpc
{
    template <
        ...
        int Tineq,
        int Teq>
    class Optimizer : public Common<Tnx, Tnu, Tny, Tph, Tch, Tineq, Teq>
    {
    ...
    public:
            ...
            const cvec<Tnu> u0)
        {
            ...
            cvec<AssignSize(sizeEnum::InputPredictionSize)> UmvVectorized;
            ...
            try
            {
                ...
                cvec<AssignSize(sizeEnum::DecVarsSize)> opt_vector;
    ...
    private:
            ...
            void *objFunc)
        {
            ...
            cvec<AssignSize(sizeEnum::DecVarsSize)> x_arr;
        ...
        //inline void _mat2mem(double* dst, Eigen::MatrixBase<Derived> &src)
        //{
        //    std::memcpy(
        //        dst,
        //        src.data(),
